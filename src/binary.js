...
export const AUTHORITY_LEXICON_MAGIC = [0x52, 0x46, 0x4c, 0x58]; // RFLX
export const AUTHORITY_LEXICON_SEGMENT_MAGIC = [0x52, 0x46, 0x4c, 0x50]; // RFLP
export const AUTHORITY_HOT_MAGIC = [0x52, 0x46, 0x4c, 0x48]; // RFLH
